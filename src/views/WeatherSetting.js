...
const WeatherSetting = ({ handleChangeCurrentPage,handleChangeCurrentCity,cityName }) => {
  ...
  const handleSave = () => {
    ...
    handleChangeCurrentPage('WeatherCard');
  ...
  return (
    <WeatherSettingWrapper>
      ...
      <ButtonGroup>
        <Back onClick={() => handleChangeCurrentPage("WeatherCard")}>返回</Back>
